    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-md">
        ...
        <div class="wrapper">
            ...
            <div class="container-fluid">
                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title tabbable-line">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li class="active">
                                                        <a href="#tab_1_3" data-toggle="tab">Subscription Details</a>
                                                    </li>
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_3">
                                                        <form action="sub_details.php" method = "post" id = "sub">
																...
																<label class="control-label">Subscription Type</label>
																		<select class="form-control input-small" name="sb_type">
											...
											<input class="form-control form-control-inline input-medium date-picker" name="sb_start_date" size="16" type="text" value="" required /></div>
															</div>
                                              ...
                                              <input class="form-control form-control-inline input-medium date-picker" name="sb_end_date" size="16" type="text" value="" required /></div>
																...
																<label class="control-label">Payment method</label>
																		<select class="form-control input-small" name="sb_payment_method">
																			<option>Cash</option>
                ...
                <!-- BEGIN FOOTER -->
                <p class="copyright">2016 © Design by
                    <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" title="Purchase Metronic just for 27$ and get lifetime updates for free" target="_blank">HourLabs!</a>
                </p>
